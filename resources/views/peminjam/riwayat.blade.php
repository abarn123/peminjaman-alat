...
@section('content')
    ...
    <div id="qrisModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
        <!-- Backdrop / Overlay gelap di belakang modal -->
        <div id="qrisModalBackdrop" class="absolute inset-0 bg-black/50 backdrop-blur-sm"></div>
        ...
        <div class="relative w-full max-w-md bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden transform transition-all duration-300 scale-100">
            ...
            <div class="bg-gradient-to-r from-red-600 to-red-700 px-5 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <button id="closeQrisModalBtn" type="button" class="text-white/80 hover:text-white transition-colors text-2xl leading-none" aria-label="Tutup">
                        &times;
                    </button>
                </div>
            </div>

            <!-- Body Modal - Informasi Pembayaran -->
            <div class="px-5 py-5 bg-gray-50">
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
                    ...
                    <div class="bg-white p-4 rounded-xl border-2 border-dashed border-gray-200 inline-block w-full">
                        <img id="qrisImage" src="" class="w-48 h-48 object-contain mx-auto" alt="QRIS Pembayaran">
                    </div>
            ...
            <div class="px-5 py-4 bg-white border-t border-gray-100">
                ...
                <p class="text-xs text-gray-400 text-center mt-3">Setelah melakukan pembayaran, silakan konfirmasi ke petugas lab</p>
            </div>
        </div>
    </div>
@endsection
