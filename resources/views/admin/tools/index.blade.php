...
@section('content')
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-500 mt-1">Kelola daftar alat yang tersedia</p>
    </div>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr class="border-b border-gray-200">
                            ...
                            <th class="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider w-32">Keterangan</th>
                        ...
                        @forelse($tools as $key => $tool)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-3">
                                    ...
                                    {{-- logika untuk status stok (tersedia, menipis, habis) --}}
                                    @if($tool->stok <= 0)
                                ...
                                <td class="px-6 py-3">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form action="{{ route('tools.destroy', $tool->id) }}" method="POST" class="inline delete-form">
                                            @csrf
                                            @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ganti confirm delete dengan SweetAlert
    document.querySelectorAll('.delete-form').forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: 'Data peminjaman terkait mungkin akan error.',
                icon: 'warning',
